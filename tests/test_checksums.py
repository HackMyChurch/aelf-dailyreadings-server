...
class TestChecksums(TestBase):
    ...
    def test_nominal(self, m_get):
        ...
        # Get checksums
        resp = self.app.get('/76/office/checksums/2024-05-10/2d')
    ...
    def test_args_validation(self, m_get):
        ...
        # Invalid durations
        self.assertEqual(404, self.app.get('/76/office/checksums/2024-05-10/-2d').status_code)
        self.assertEqual(400, self.app.get('/76/office/checksums/2024-05-10/0d').status_code)
        self.assertEqual(400, self.app.get('/76/office/checksums/2024-05-10/8d').status_code)

        # Invalid date
        self.assertEqual(400, self.app.get('/76/office/checksums/2024-00-00/7d').status_code)
        self.assertEqual(400, self.app.get('/76/office/checksums/2024-05-10-/7d').status_code)
